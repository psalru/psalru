...
# Парсинг сайта [«Приоритета 2030»](https://priority2030.ru/analytics/)
...
Чтобы не мучать сильно сайт «Приоритет 2030», по каждому университету данный собираются **с задержкой в 0,5 секунды** (относитесь с заботой к источникам своих данных 🤗), соответственно собирается всё около 1-2 минут.
...
Получившийся **набор данных**, на момент написания, вы можете ⬇️ скачать по [данной ссылке](https://storage.yandexcloud.net/psal.public/datasets/2023-05-03_universities_kpis_from_p2030_site.xlsx).
